            ...
            try:
                for category in guild_to.categories:
                    try:
                        ...
                        print_warning(f"Kanalın {channel_text.name} herhangi bir kategorisi YOK BU ENGEL DEĞİL AMK!")
                        category = None
                        break
            ...
            try:
                for category in guild_to.categories:
                    try:
                        ...
                        print_warning(f"Kanalın {channel_voice.name} herhangi bir kategorisi YOK BU BİR ENGEL DEĞİL AMK!")
                        category = None
                        break
